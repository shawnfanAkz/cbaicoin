CB AI COIN Core version *0.15.0.1* is now available from:

  <https://CB AI COIN.org/bin/CB AI COIN-core-0.15.0.1/>

and

  <https://CB AI COINcore.org/bin/CB AI COIN-core-0.15.0.1/>

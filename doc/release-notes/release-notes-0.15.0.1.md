CI AI COIN Core version *0.15.0.1* is now available from:

  <https://CI AI COIN.org/bin/CI AI COIN-core-0.15.0.1/>

and

  <https://CI AI COINcore.org/bin/CI AI COIN-core-0.15.0.1/>

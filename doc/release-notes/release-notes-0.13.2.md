CI AI COIN Core version 0.13.2 is now available from:

  <https://CI AI COIN.org/bin/CI AI COIN-core-0.13.2/>
...
- #8908 `4a974b2` Update CI AI COIN-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow CI AI COIN-tx to create v2 transactions (btcdrak)

CB AI COIN Core version 0.13.2 is now available from:

  <https://CB AI COIN.org/bin/CB AI COIN-core-0.13.2/>
...
- #8908 `4a974b2` Update CB AI COIN-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow CB AI COIN-tx to create v2 transactions (btcdrak)

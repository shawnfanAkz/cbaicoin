CI AI COIN Core version 0.10.2 is now available from:

  <https://CI AI COIN.org/bin/CI AI COIN-core-0.10.2/>
...
characters (https://github.com/CI AI COIN/CI AI COIN/issues/6078).

For other platforms there are no notable changes.

For the notable changes in 0.10, refer to the release notes
at https://github.com/CI AI COIN/CI AI COIN/blob/v0.10.0/doc/release-notes.md

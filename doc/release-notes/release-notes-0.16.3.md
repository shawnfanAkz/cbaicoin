CB AI COIN Core version 0.16.3 is now available from:

  <https://CB AI COINcore.org/bin/CB AI COIN-core-0.16.3/>
...
been discovered in CB AI COIN Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` CB AI COINconsensus: invalid flags error should be set to `CB AI COINconsensus_err` (afk11)

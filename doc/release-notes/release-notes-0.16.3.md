CI AI COIN Core version 0.16.3 is now available from:

  <https://CI AI COINcore.org/bin/CI AI COIN-core-0.16.3/>
...
been discovered in CI AI COIN Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` CI AI COINconsensus: invalid flags error should be set to `CI AI COINconsensus_err` (afk11)

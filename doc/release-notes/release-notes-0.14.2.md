CB AI COIN Core version 0.14.2 is now available from:

  <https://CB AI COIN.org/bin/CB AI COIN-core-0.14.2/>
...
(in CB AI COIN Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate CB AI COIN-config.h as necessary (theuni)

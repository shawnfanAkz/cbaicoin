CI AI COIN Core version 0.14.2 is now available from:

  <https://CI AI COIN.org/bin/CI AI COIN-core-0.14.2/>
...
(in CI AI COIN Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate CI AI COIN-config.h as necessary (theuni)

CI AI COIN Core version 0.10.4 is now available from:

  <https://CI AI COIN.org/bin/CI AI COIN-core-0.10.4/>
...
- #6953 `43c2789` Split CI AI COIN-tx into its own package
- #6953 `dfe0d4d` Include CI AI COIN-tx binary on Debian/Ubuntu

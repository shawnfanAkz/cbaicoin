CB AI COIN Core version 0.10.4 is now available from:

  <https://CB AI COIN.org/bin/CB AI COIN-core-0.10.4/>
...
- #6953 `43c2789` Split CB AI COIN-tx into its own package
- #6953 `dfe0d4d` Include CB AI COIN-tx binary on Debian/Ubuntu

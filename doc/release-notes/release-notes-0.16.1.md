CI AI COIN Core version 0.16.1 is now available from:

  <https://CI AI COINcore.org/bin/CI AI COIN-core-0.16.1/>
...
- #12843 `df38b13` Test starting CI AI COINd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure CI AI COINd processes are cleaned up when tests end (sdaftuar)

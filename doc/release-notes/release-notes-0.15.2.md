CB AI COIN Core version *0.15.2* is now available from:

  <https://CB AI COINcore.org/bin/CB AI COIN-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in CB AI COIN-tx (TheBlueMatt)

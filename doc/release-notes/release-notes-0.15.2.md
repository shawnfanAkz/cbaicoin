CI AI COIN Core version *0.15.2* is now available from:

  <https://CI AI COINcore.org/bin/CI AI COIN-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in CI AI COIN-tx (TheBlueMatt)

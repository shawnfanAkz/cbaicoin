CI AI COIN Core version 0.10.3 is now available from:

  <https://CI AI COIN.org/bin/CI AI COIN-core-0.10.3/>
...
(see https://github.com/CI AI COIN/CI AI COIN/pull/6793, as well as the 0.11.0

CB AI COIN Core version 0.9.4 is now available from:

  https://CB AI COIN.org/bin/0.9.4/
...
this update is incompatible with the CB AI COIN system and could lead to consensus
forks.

CB AI COIN Core released binaries from https://CB AI COIN.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~CB AI COIN/+archive/ubuntu/CB AI COIN
- A third-party or self-compiled CB AI COIN Core

upgrade to CB AI COIN Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

CI AI COIN Core version 0.9.4 is now available from:

  https://CI AI COIN.org/bin/0.9.4/
...
this update is incompatible with the CI AI COIN system and could lead to consensus
forks.

CI AI COIN Core released binaries from https://CI AI COIN.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~CI AI COIN/+archive/ubuntu/CI AI COIN
- A third-party or self-compiled CI AI COIN Core

upgrade to CI AI COIN Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

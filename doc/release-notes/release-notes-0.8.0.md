CB AI COIN-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/CB AI COIN/files/CB AI COIN/CB AI COIN-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the CB AI COIN
...
New/changed settings (command-line or CB AI COIN.conf file)
--------------------------------------------------------

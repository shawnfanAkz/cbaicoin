CI AI COIN-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/CI AI COIN/files/CI AI COIN/CI AI COIN-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the CI AI COIN
...
New/changed settings (command-line or CI AI COIN.conf file)
--------------------------------------------------------

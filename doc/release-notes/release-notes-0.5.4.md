CI AI COIN version 0.5.4 is now available for download at:
http://sourceforge.net/projects/CI AI COIN/files/CI AI COIN/CI AI COIN-0.5.4/
...
http://gitorious.org/CI AI COIN/CI AI COINd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix CI AI COIN-Qt notifications under Growl 1.3.
Increase required age of CI AI COIN-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCI AI COIN properly when installing CI AI COIN-Qt over it. (Windows)

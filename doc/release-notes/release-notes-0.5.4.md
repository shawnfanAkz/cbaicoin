CB AI COIN version 0.5.4 is now available for download at:
http://sourceforge.net/projects/CB AI COIN/files/CB AI COIN/CB AI COIN-0.5.4/
...
http://gitorious.org/CB AI COIN/CB AI COINd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix CB AI COIN-Qt notifications under Growl 1.3.
Increase required age of CB AI COIN-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCB AI COIN properly when installing CB AI COIN-Qt over it. (Windows)

...
This document provides guidelines for internationalization of the CI AI COIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `CI AI COIN_en.ts` remains unchanged.

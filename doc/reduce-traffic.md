...
By default, CI AI COIN Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that CI AI COIN's trustless model works best if you are

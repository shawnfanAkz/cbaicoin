# RapidCheck property-based testing for CI AI COIN Core

## Concept

Property-based testing is experimentally being added to CI AI COIN Core with
...
If RapidCheck is installed, CI AI COIN Core will automatically run the
...
3. Configure CI AI COIN Core with RapidCheck.

    `cd` to the directory of your local CI AI COIN repository and run
...
4. Build CI AI COIN Core with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_CI AI COIN-crypto_gen.o
    CXX      test/test_CI AI COIN-key_properties.o
    ```
...
That's it! You are now running property-based tests in CI AI COIN Core.

# RapidCheck property-based testing for CB AI COIN Core

## Concept

Property-based testing is experimentally being added to CB AI COIN Core with
...
If RapidCheck is installed, CB AI COIN Core will automatically run the
...
3. Configure CB AI COIN Core with RapidCheck.

    `cd` to the directory of your local CB AI COIN repository and run
...
4. Build CB AI COIN Core with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_CB AI COIN-crypto_gen.o
    CXX      test/test_CB AI COIN-key_properties.o
    ```
...
That's it! You are now running property-based tests in CB AI COIN Core.

# PSBT Howto for CI AI COIN Core

Since CI AI COIN Core 0.17, an RPC interface exists for Partially Signed CI AI COIN
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/CI AI COIN/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for CI AI COIN transactions that are not fully signed
...
#### Multisig with multiple CI AI COIN Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
CI AI COIN Core. We assume their wallets only contain the multisig funds. In case
they also have a personal wallet, this can be accomplished through the
multiwallet feature - possibly resulting in a need to add `-rpcwallet=name` to
the command line in case `CI AI COIN-cli` is used.
...
Later, when *V* CICX has been received on *Amulti*, and Bob and Carol want to

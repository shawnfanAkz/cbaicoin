# PSBT Howto for CB AI COIN Core

Since CB AI COIN Core 0.17, an RPC interface exists for Partially Signed CB AI COIN
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/CB AI COIN/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for CB AI COIN transactions that are not fully signed
...
#### Multisig with multiple CB AI COIN Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
CB AI COIN Core. We assume their wallets only contain the multisig funds. In case
they also have a personal wallet, this can be accomplished through the
multiwallet feature - possibly resulting in a need to add `-rpcwallet=name` to
the command line in case `CB AI COIN-cli` is used.

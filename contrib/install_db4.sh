...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the CB AI COIN repository."
  exit 1
fi
...
# See https://github.com/CB AI COIN/CB AI COIN/issues/16064
...
echo 'When compiling CB AI COINd, run `./configure` in the following way:'
echo

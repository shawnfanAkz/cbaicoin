...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the CI AI COIN repository."
  exit 1
fi
...
# See https://github.com/CI AI COIN/CI AI COIN/issues/16064
...
echo 'When compiling CI AI COINd, run `./configure` in the following way:'
echo

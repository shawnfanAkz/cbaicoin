# Bootstrappable CI AI COIN Core Builds

This directory contains the files necessary to perform bootstrappable CI AI COIN
Core builds.
...
- 24GB of free disk space on the partition that the CI AI COIN Core git repository
  resides in
...
For a CI AI COIN Core depends development environment, simply invoke
...
From the top of a clean CI AI COIN Core repository:
...
To use dongcarl's substitute server for CI AI COIN Core builds after having

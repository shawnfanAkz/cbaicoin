# Bootstrappable CB AI COIN Core Builds

This directory contains the files necessary to perform bootstrappable CB AI COIN
Core builds.
...
- 24GB of free disk space on the partition that the CB AI COIN Core git repository
  resides in
...
For a CB AI COIN Core depends development environment, simply invoke
...
From the top of a clean CB AI COIN Core repository:
...
To use dongcarl's substitute server for CB AI COIN Core builds after having

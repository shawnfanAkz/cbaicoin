...
/* A AEAD class for ChaCha20-Poly1305@CI AI COIN.
 *
 ...
 *
 * The chacha20-poly1305@CI AI COIN combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@CI AI COIN cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@CI AI COIN are relatively fast in

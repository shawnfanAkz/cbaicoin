    ...
    platformStyle(_platformStyle)
{
    ...
    // normal CI AI COIN address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying CI AI COIN address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CI AI COINAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);

...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, CB AI COINUnits::SeparatorStyle separators=CB AI COINUnits::separatorStandard) const;

...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, CI AI COINUnits::SeparatorStyle separators=CI AI COINUnits::separatorStandard) const;

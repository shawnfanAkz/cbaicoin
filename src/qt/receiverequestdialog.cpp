...
#include <config/CI AI COIN-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCI AI COINURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CI AI COINUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCI AI COINURI(info));
}

...
#include <config/CB AI COIN-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCB AI COINURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CB AI COINUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCB AI COINURI(info));
}

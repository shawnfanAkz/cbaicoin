 ...
 *  A CTxDestination is the internal data type encoded in a CI AI COIN address
 */
...
/**
 * Generate a CI AI COIN scriptPubKey for the given CTxDestination. Returns a P2PKH

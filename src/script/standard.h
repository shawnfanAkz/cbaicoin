 ...
 *  A CTxDestination is the internal data type encoded in a CB AI COIN address
 */
...
/**
 * Generate a CB AI COIN scriptPubKey for the given CTxDestination. Returns a P2PKH

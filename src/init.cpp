 ...
 */
static const char* BITCOIN_PID_FILENAME = "CI AI COINd.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/CI AI COIN/CI AI COIN>";
    const std::string URL_WEBSITE = "<https://CI AI COINcore.org>";
...
/** Sanity checks
 *  Ensure that CI AI COIN is running in a usable environment with all
...
{
    // Make sure only a single CI AI COIN process is using the data directory.
...
bool AppInitMain(NodeContext& node)
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the " /* Continued */
                  "current working directory '%s'. This is fragile, because if CI AI COIN is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if CI AI COIN is started while in a temporary directory.\n",

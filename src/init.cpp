 ...
 */
static const char* BITCOIN_PID_FILENAME = "CB AI COINd.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/CB AI COIN/CB AI COIN>";
    const std::string URL_WEBSITE = "<https://CB AI COINcore.org>";
...
/** Sanity checks
 *  Ensure that CB AI COIN is running in a usable environment with all
...
{
    // Make sure only a single CB AI COIN process is using the data directory.
...
bool AppInitMain(NodeContext& node)
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the " /* Continued */
                  "current working directory '%s'. This is fragile, because if CB AI COIN is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if CB AI COIN is started while in a temporary directory.\n",

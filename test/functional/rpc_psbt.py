...
class PSBTTest(CB AI COINTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 CICX
        ...
        # feeRate of 0.1 CICX / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 CICX / KB produces a total fee well above -maxtxfee

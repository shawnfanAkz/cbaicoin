...
class SegWitTest(CB AI COINTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older CB AI COINd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let CB AI COINd fill it in.

...
class SegWitTest(CI AI COINTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older CI AI COINd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let CI AI COINd fill it in.

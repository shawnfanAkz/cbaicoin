...
class FullBlockTest(CB AI COINTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure CB AI COINd isn't accepting b26
        ...
        # Extend the b28 chain to make sure CB AI COINd isn't accepting b28
        ...
        # CB AI COINd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the CB AI COIN code has custom code which does so);

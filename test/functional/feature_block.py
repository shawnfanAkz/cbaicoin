...
class FullBlockTest(CI AI COINTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure CI AI COINd isn't accepting b26
        ...
        # Extend the b28 chain to make sure CI AI COINd isn't accepting b28
        ...
        # CI AI COINd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the CI AI COIN code has custom code which does so);

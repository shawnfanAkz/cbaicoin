...
By default, CB AI COINd will dump mempool on shutdown and
...
class MempoolPersistTest(CB AI COINTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent CB AI COINd from writing mempool.dat to disk. Verify that `savemempool` fails")

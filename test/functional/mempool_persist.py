...
By default, CI AI COINd will dump mempool on shutdown and
...
class MempoolPersistTest(CI AI COINTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent CI AI COINd from writing mempool.dat to disk. Verify that `savemempool` fails")
